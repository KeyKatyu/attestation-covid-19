...
public enum MotifDeplacement {
    ...
    HANDICAP("Déplacement des personnes en situation de handicap et leur accompagnant.", 349),
    CONVOCATION("Déplacements pour répondre à une convocation judiciaire ou administrative.", 320),
    MISSIONS("Déplacements pour participer à des missions d’intérêt général sur demande de l’autorité administrative.", 300),
